...
```{r}
df_pub <- read_excel("../database/preprocessed_content_analysis.xlsx")
```
...
# Assuming 'topic_correlations' is your correlation matrix
...
V(network_graph)$size <- degree(network_graph) * 12  # Scale can be adjusted
